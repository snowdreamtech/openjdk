...
OpenJDK Docker 镜像，提供标准化的容器基础，具有灵活的入口点系统、多架构支持以及跨 Alpine、Debian 和 Rocky Linux 发行版的一致配置模式。

## 概述

这些 OpenJDK Docker 镜像作为运行 Java 应用程序的基础起点。它提供：
...
OpenJDK 镜像包含一个灵活的入口点系统，在启动应用程序之前执行自定义初始化脚本。
